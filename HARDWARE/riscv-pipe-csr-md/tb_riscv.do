...
add wave            -label instrlast dut/instruction_decoder0/instrlast
...
add wave            -label waitfordata dut/instruction_decoder0/waitfordata
add wave            -label penalty dut/instruction_decoder0/penalty
add wave            -label start dut/instruction_decoder0/start
add wave            -label ready dut/instruction_decoder0/md_ready
