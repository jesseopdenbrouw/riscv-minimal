...
\draw[->] (18,-2) -- ++(4,0) node[midway,above] {address};
...
To test one of the programs, dive in one of the directories and copy the file with \texttt{.vhd} extension to the directory containing the VHDL description under the name \texttt{processor\_common\_rom.vhd}.
